package de.morigm.greenlib.api.managers.v1_11_R1;
...
import net.minecraft.server.v1_11_R1.PacketPlayOutCombatEvent.EnumCombatEventType;
import net.minecraft.server.v1_11_R1.IChatBaseComponent;
import net.minecraft.server.v1_11_R1.BossBattle;
import net.minecraft.server.v1_11_R1.BossBattle.BarColor;
import net.minecraft.server.v1_11_R1.BossBattle.BarStyle;
...
public class PlayerManager extends de.morigm.greenlib.api.managers.PlayerManager {
	...
	public void sendActionBar(String s) 
	{
		...
		PacketPlayOutTitle bar = new PacketPlayOutTitle(EnumTitleAction.ACTIONBAR, new ChatComponentText(s));
	...
	public void sendPacket(PacketPlayOut packet) 
	{
		...
		if(packet instanceof PacketPlayOutAbilities)
		{
			...
			pack = new net.minecraft.server.v1_11_R1.PacketPlayOutAbilities(pa);
		}
		if(packet instanceof PacketPlayOutAnimation)
		{
			PacketPlayOutAnimation pa = (PacketPlayOutAnimation) packet;
			pack = new net.minecraft.server.v1_11_R1.PacketPlayOutAnimation(((CraftEntity)pa.a()).getHandle(), pa.b());
		}
		if(packet instanceof PacketPlayOutAttachEntity)
		{
			PacketPlayOutAttachEntity pa = (PacketPlayOutAttachEntity) packet;
			pack = new net.minecraft.server.v1_11_R1.PacketPlayOutAttachEntity(((CraftEntity)pa.a()).getHandle(), ((CraftEntity)pa.b()).getHandle());
		}
		if(packet instanceof PacketPlayOutBed)
		{
			PacketPlayOutBed pa = (PacketPlayOutBed) packet;
			pack = new net.minecraft.server.v1_11_R1.PacketPlayOutBed(((CraftPlayer)pa.a()).getHandle(),new BlockPosition(pa.b().getX(), pa.b().getY(), pa.b().getZ()));
		}
		if(packet instanceof PacketPlayOutBlockAction)
		{
			PacketPlayOutBlockAction pa = (PacketPlayOutBlockAction) packet;
			pack = new net.minecraft.server.v1_11_R1.PacketPlayOutBlockAction(new BlockPosition(pa.a().getX(), pa.a().getY(), pa.a().getZ()),(net.minecraft.server.v1_11_R1.Block) pa.d().getState(),pa.b(),pa.c());
		}
		if(packet instanceof PacketPlayOutBlockBreakAnimation)
		{
			...
			pack = new net.minecraft.server.v1_11_R1.PacketPlayOutBlockBreakAnimation(pa.getEntityID(), new BlockPosition(pa.getLocation().getX(), pa.getLocation().getY(), pa.getLocation().getZ()), pa.getCount());
		}
		if(packet instanceof PacketPlayOutBlockChange)
		{
			PacketPlayOutBlockChange pa = (PacketPlayOutBlockChange) packet;
			pack = new net.minecraft.server.v1_11_R1.PacketPlayOutBlockChange(((CraftWorld)pa.getWorld()).getHandle(),new BlockPosition(pa.getLocation().getX(), pa.getLocation().getY(), pa.getLocation().getZ()));
			((net.minecraft.server.v1_11_R1.PacketPlayOutBlockChange)pack).block = CraftMagicNumbers.getBlock(pa.getMaterial().getId()).fromLegacyData(pa.getData());
		}
		if(packet instanceof PacketPlayOutBoss)
		{
			PacketPlayOutBoss pa = (PacketPlayOutBoss) packet;
			net.minecraft.server.v1_11_R1.PacketPlayOutBoss.Action action = net.minecraft.server.v1_11_R1.PacketPlayOutBoss.Action.valueOf(pa.getAction().name().toUpperCase());
			...
			pack = new net.minecraft.server.v1_11_R1.PacketPlayOutBoss(action, battle);
		}
		if(packet instanceof PacketPlayOutCamera)
		{
			...
			pack = new net.minecraft.server.v1_11_R1.PacketPlayOutCamera(ce.getHandle());
		}
		if(packet instanceof PacketPlayOutChat)
		{
		    ...
		    for (int j = 0; j < i - 1 ; j++)
		    {
		      ...
		      cp.getHandle().playerConnection.sendPacket(new net.minecraft.server.v1_11_R1.PacketPlayOutChat(component));
		    }
		    IChatBaseComponent component = arrayOfIChatBaseComponent[i - 1];
		    pack = new net.minecraft.server.v1_11_R1.PacketPlayOutChat(component);
		}
		if(packet instanceof PacketPlayOutCloseWindow)
		{
			PacketPlayOutCloseWindow pa = (PacketPlayOutCloseWindow) packet;
			pack = new net.minecraft.server.v1_11_R1.PacketPlayInCloseWindow(pa.getWindow());
		}
		if(packet instanceof PacketPlayOutCollect)
		{
			PacketPlayOutCollect pa = (PacketPlayOutCollect) packet;
			pack = new net.minecraft.server.v1_11_R1.PacketPlayOutCollect(pa.getCollectedEntityID(), pa.getCollectorEntityID(), pa.getPickupItemCount());
		}
		if(packet instanceof PacketPlayOutCombatEvent)
		{
			...
			pack = new net.minecraft.server.v1_11_R1.PacketPlayOutCombatEvent(new CombatTracker(entityLiving),EnumCombatEventType.valueOf(pa.getType().name().toUpperCase()),pa.is());
		}
		if(packet instanceof PacketPlayOutCustomPayload)
		{
			PacketPlayOutCustomPayload pa = (PacketPlayOutCustomPayload) packet;
			PacketDataSerializer packetDataSerializer = ((de.morigm.greenlib.api.buffer.v1_11_R1.PacketBuffer)pa.getPacketBuffer()).getPacketDataSerializer();
			pack = new net.minecraft.server.v1_11_R1.PacketPlayOutCustomPayload(pa.getChannel(), packetDataSerializer);
		}
		if(packet instanceof PacketPlayOutCustomSoundEffect)
		{
			...
			pack = new net.minecraft.server.v1_11_R1.PacketPlayOutCustomSoundEffect(pa.getSoundId(), soundCategory, pa.getX(), pa.getY(), pa.getZ(), pa.getVolume(), pa.getPitch());
		}
		if(packet instanceof PacketPlayOutEntity)
		{
			PacketPlayOutEntity pa = (PacketPlayOutEntity) packet;
			pack = new net.minecraft.server.v1_11_R1.PacketPlayOutEntity(pa.getEntityId());
		}
		if(packet instanceof PacketPlayOutRelEntityMoveLook)
		{
			...
			pack = new net.minecraft.server.v1_11_R1.PacketPlayOutEntity.PacketPlayOutRelEntityMoveLook(pa.getEntityId(), pa.getDeltaX(), pa.getDeltaY(), pa.getDeltaZ(), pa.getPitch(), pa.getYaw(), pa.isOnGround());
		}
		if(packet instanceof PacketPlayOutRelEntityMoveLook)
		{
			PacketPlayOutRelEntityMoveLook  pa = (PacketPlayOutRelEntityMoveLook) packet;
			pack = new net.minecraft.server.v1_11_R1.PacketPlayOutEntity.PacketPlayOutRelEntityMove(pa.getEntityId(), pa.getDeltaX(), pa.getDeltaY(), pa.getDeltaZ(), pa.isOnGround());
		}
		if(packet instanceof PacketPlayOutEntityLook)
		{
			PacketPlayOutEntityLook pa = (PacketPlayOutEntityLook) packet;
			pack = new net.minecraft.server.v1_11_R1.PacketPlayOutEntity.PacketPlayOutEntityLook(pa.getEntityId(), pa.getPitch(), pa.getYaw(), pa.isOnGround());
		}
		...
		if(packet instanceof PacketPlayOutEntityEffect)
		{
			...
			pack = new net.minecraft.server.v1_11_R1.PacketPlayOutEntityEffect(pa.getParamint(), new MobEffect(MobEffectList.fromId(pa.getMobEffect().getMobEffectList().getEffectID()), pa.getMobEffect().getI(), pa.getMobEffect().getX(), pa.getMobEffect().isParm1(), pa.getMobEffect().isParm2()));
		}
