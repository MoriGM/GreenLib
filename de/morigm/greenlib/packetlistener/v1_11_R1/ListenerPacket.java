package de.morigm.greenlib.packetlistener.v1_11_R1;
...
public class ListenerPacket extends de.morigm.greenlib.packetlistener.ListenerPacket {
	...
	public boolean listenAsync(Packet<?> p) 
	{
		...
		if(p instanceof PacketPlayInBlockDig)
		{
			...
			if(pa.b().equals(net.minecraft.server.v1_11_R1.EnumDirection.DOWN))
				d = EnumDirection.DOWN;
			if(pa.b().equals(net.minecraft.server.v1_11_R1.EnumDirection.UP))
				d = EnumDirection.UP;
			if(pa.b().equals(net.minecraft.server.v1_11_R1.EnumDirection.EAST))
				d = EnumDirection.EAST;
			if(pa.b().equals(net.minecraft.server.v1_11_R1.EnumDirection.WEST))
				d = EnumDirection.WEST;
			if(pa.b().equals(net.minecraft.server.v1_11_R1.EnumDirection.NORTH))
				d = EnumDirection.NORTH;
			if(pa.b().equals(net.minecraft.server.v1_11_R1.EnumDirection.SOUTH))
				d = EnumDirection.SOUTH;
			EnumPlayerDigType epdt = null;
			if(pa.c().equals(net.minecraft.server.v1_11_R1.PacketPlayInBlockDig.EnumPlayerDigType.ABORT_DESTROY_BLOCK))
				epdt = EnumPlayerDigType.ABORT_DESTROY_BLOCK;
			if(pa.c().equals(net.minecraft.server.v1_11_R1.PacketPlayInBlockDig.EnumPlayerDigType.DROP_ALL_ITEMS))
				epdt = EnumPlayerDigType.DROP_ALL_ITEMS;
			if(pa.c().equals(net.minecraft.server.v1_11_R1.PacketPlayInBlockDig.EnumPlayerDigType.DROP_ITEM))
				epdt = EnumPlayerDigType.DROP_ITEM;
			if(pa.c().equals(net.minecraft.server.v1_11_R1.PacketPlayInBlockDig.EnumPlayerDigType.RELEASE_USE_ITEM))
				epdt = EnumPlayerDigType.RELEASE_USE_ITEM;
			if(pa.c().equals(net.minecraft.server.v1_11_R1.PacketPlayInBlockDig.EnumPlayerDigType.START_DESTROY_BLOCK))
				epdt = EnumPlayerDigType.START_DESTROY_BLOCK;
			if(pa.c().equals(net.minecraft.server.v1_11_R1.PacketPlayInBlockDig.EnumPlayerDigType.STOP_DESTROY_BLOCK))
				epdt = EnumPlayerDigType.STOP_DESTROY_BLOCK;
			if(pa.c().equals(net.minecraft.server.v1_11_R1.PacketPlayInBlockDig.EnumPlayerDigType.SWAP_HELD_ITEMS))
